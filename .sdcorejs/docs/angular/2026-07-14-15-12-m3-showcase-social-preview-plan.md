...
11. EDIT `projects/demo/src/app/sections/footer.component.ts` - present SDCoreJS brand, Trần Thuận Nghĩa, public email, license, package links, and implementation stack in an accessible responsive footer.

### Phase 3 - Favicon, social artwork, and crawler metadata

12. CREATE `projects/demo/public/og-image.png` - use the image-generation workflow with `brand/logo.png`/`brand/logo-text.png` as references to produce a brand-faithful 1200×630 social card; visually inspect the result and reject altered logo geometry/lettering.
...
- Inspect `projects/demo/public/og-image.png` at original resolution and verify 1200×630 dimensions.
