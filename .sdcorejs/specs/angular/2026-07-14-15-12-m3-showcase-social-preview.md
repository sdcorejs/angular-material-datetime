...
description: Approved M3-only showcase, brand metadata, author identity, and social preview contract.
contract_id: angular-material-datetime-m3-showcase-20260714
requirement_id: req-m3-showcase-social-preview-20260714
approvedAt: 2026-07-14T15:12:19.8238862+07:00
...
sourceDraftPath: .sdcorejs/docs/angular/2026-07-14-15-04-m3-showcase-social-preview-spec.md
...
# M3-only showcase and social preview - Approved Spec
...
spec_context:
  ...
  assumptions:
    ...
    - Public author is Tráº§n Thuáº­n NghÄ©a with tran.thuan.nghia@gmail.com and https://github.com/sdcorejs
...
The social artwork will be a 1200Ã—630 PNG under the demo public assets, use the existing SDCoreJS logo without redesign, and communicate the package name plus its M3 datetime-picker value proposition. The same image will be used by Open Graph and Twitter metadata.

Author identity is public and explicit:

- Name: Tráº§n Thuáº­n NghÄ©a
...
- `projects/demo/public/og-image.png` - create the 1200Ã—630 social preview card.
...
- AC-001 - A repository search across source and README finds no user-facing Material 2, M2, hybrid M2+M3, or legacy-theme support claim; unrelated compiler â€œlegacy message IDâ€ configuration is unchanged.
...
- AC-013 - `projects/demo/public/og-image.png` is exactly 1200Ã—630, uses the existing SDCoreJS brand mark, remains legible at preview size, and names Angular Material Datetime plus its M3 positioning.
...
- AC-015 - Footer, root package metadata, and all three published package manifests identify Tráº§n Thuáº­n NghÄ©a, `tran.thuan.nghia@gmail.com`, and `https://github.com/sdcorejs` consistently.
...
- Public author confirmed as Trần Thuận Nghĩa.
- Public email confirmed as `tran.thuan.nghia@gmail.com`.
- GitHub/brand profile remains `https://github.com/sdcorejs`.
